...
public class ColecaoGui extends javax.swing.JFrame {
    ...
    private ColecaoTableModel model;

    public ColecaoGui() {
        initComponents();
        List<Colecao> lista = new ArrayList<Colecao>();
        ColecaoController a = new ColecaoController();
        lista = a.listarColecao();

        //cria o modelo de Produto      
        model = new ColecaoTableModel(lista);
    ...
    private void btInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btInserirActionPerformed
        InserirColecaoGui im = new InserirColecaoGui(model);
        im.setVisible(true);
    ...
    private void btRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRemoverActionPerformed
        ...
        if (selecionado >= 0) {
            ...
            if (mc.excluir(i)){
            model.removeColecao(selecionado);
            }
        } else {
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        if (selecionado >= 0) {
         ...
         //   AtualizarColecaoGuii am = new AtualizarColecaoGuii(selecionado, cdModelo, model);
      //      am.setVisible(true);
        } else {
    ...
    private void efetuaPesquisa() {
        String tema = campoPesquisa.getText();
        List<Colecao> lista = new ArrayList<Colecao>();
        ColecaoController a = new ColecaoController();
        lista = a.listarColecaoByTema(tema);
        model.limpar();
